...
fixed_screens = """    const SCREENS = [
      ...
      { // SCREEN 4
        type: 'story',
        text: "<p>She stamps \\"MYSTERY\\" on your badge and waves you through. Inside: total chaos. An Enokimushroom is balanced on a stack of cookbooks.</p>",
        scene: "<img src=\\"assets/story/Story_4.png\\" class=\\"scene-img\\" alt=\\"Enokimushroom on books\\" />",
        btns: ["👀 Head straight to the food stalls.", "🗺️ Look for a map. There has to be a map."]
      },
      { // SCREEN 5 - Q2
        type: 'choice',
        qIdx: 1,
        text: "<p><strong>A Heirloomtomato sprints over. \\"Mystery Ingredient! Cook-Off team needs a fourth. Quick question first:\\"<br/><br/>How do you decide what to eat?</strong></p>",
        scene: "<img src=\\"assets/story/Story_5.png\\" class=\\"scene-img\\" alt=\\"Heirloomtomato sprinting\\" />",
        answers: [
      ...
      { // SCREEN 7 - Q3
        type: 'choice',
        qIdx: 2,
        text: "<p><strong>Cook-Off theme drops: \\"A dish you've NEVER made before.\\" Avotoast crumples their prep sheet. Your honest reaction?<br/><br/>Your approach to new recipes and cuisines?</strong></p>",
      ...
      { // SCREEN 8
        type: 'story',
        text: "<p>A Tortlerry knocks over the entire spice rack. The Springles team is on fire — on purpose apparently. 3 minutes left.</p>",
      ...
      { // SCREEN 9 - Q4
        type: 'choice',
        qIdx: 3,
        text: "<p><strong>2 seconds to spare. The judges file in. A Truffle, a Century Egg, an Apple Juice already crying. The Truffle looks at your dish, then at you:<br/><br/>How important is it that food tastes incredible, even if it's unhealthy?</strong></p>",
      ...
      { // SCREEN 10
        type: 'story',
        text: "<p>Apple Juice bursts into tears. Happy ones. The Century Egg writes something very long. The Truffle nods once. \\"Walk with me.\\"</p>",
      ...
      { // SCREEN 11
        type: 'story',
        text: "<p>The Truffle leads you to the ForkVille Night Market. Dogerry is doing impressions. A Crushedtom looks like it's had a rough day. Bakeddog is still asleep, different bench.</p>",
      ...
      { // SCREEN 13 - Q5
        type: 'choice',
        qIdx: 4,
        text: "<p><strong>Morsel gestures at the whole market. Groups of food characters sharing plates. One Enokimushroom alone on a rooftop eating, looking completely at peace.<br/><br/>Food is best when shared — or is it?</strong></p>",
      ...
      { // SCREEN 14
        type: 'story',
        text: "<p>Morsel nods like you've confirmed everything, then leaves without explaining. A Stringcheese stretches dramatically past. A Ketchupandmayo is aggressively debating condiment philosophy with a Puff.</p>",
      ...
      { // SCREEN 15
        type: 'story',
        text: "<p>The Truffle reappears. \\"One last stop.\\" It leads you into the ForkVille Test Kitchen — either immaculate or completely destroyed depending on who was in last.</p>",
      ...
      { // SCREEN 16 - Q6
        type: 'choice',
        qIdx: 5,
        text: "<p><strong>The Truffle leans against a counter and watches you take it in. \\"When you cook — what does your kitchen actually look like?\\"<br/><br/>What does your kitchen look like mid-cook?</strong></p>",
      ...
      { // SCREEN 17
        type: 'story',
        text: "<p>The Truffle smiles for the first time. Back at the arena the results board is about to light up. The whole festival has gathered. Springles is near some wiring.</p>",
      ...
      { // SCREEN 18
        type: 'story',
        text: "<p>A Dogerry starts a drumroll on an overturned pot. The Truffle turns to you. \"We've always known what you are. Ready?\"</p>",
